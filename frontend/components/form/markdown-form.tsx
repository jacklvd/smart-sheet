...
export default function MarkdownForm() {
    const [activeTab, setActiveTab] = useState<"to_markdown" | "to_text">("to_markdown");
        ...
        <div className="w-full max-w-3xl mx-auto">
            <Card>
                    ...
                    >
                        ...
                        {showInfo && (
                            <Alert className="mt-4">
                                ...
                                <AlertTitle>
                                    {activeTab === "to_markdown" ? "Text to Markdown" : "Markdown to Text"} Mode
                                </AlertTitle>
                                <AlertDescription>
                                    {activeTab === "to_markdown" ? (
                                        <div className="text-sm">
                                            <p>This mode converts plain text to Markdown format. The converter will:</p>
                                            <ul className="list-disc pl-5 mt-2 space-y-1">
                                                <li>Detect code blocks and wrap them in ```py ``` for Python code</li>
                                                <li>Format single HTML tags with backticks like `&lt;div&gt;`</li>
                                        ...
                                        <div className="text-sm">
                                            ...
                                            <ul className="list-disc pl-5 mt-2 space-y-1">
                                                ...
                                                <li>Format lists with appropriate numbers or bullets</li>
                ...
                <CardFooter className="text-xs text-muted-foreground">
                    {activeTab === "to_markdown" ? (
                        <p>
                            Our converter detects code blocks and wraps them in triple backticks with language identifiers.
                            Python code will be wrapped in ```py ... ``` automatically.
                        </p>
                    ) : (
                        <p>
                            When converting from Markdown, formatting such as bold, italic, and headings will be
                            converted to plain text while preserving the overall structure.
                        </p>
                    )}
                </CardFooter>
            </Card>
